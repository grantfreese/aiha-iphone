...
#import "HeatStressListViewController.h"
...
@implementation HeatStressListViewController
...
//#warning Incomplete method implementation.
    ...
    HeatStressManager *manager = [HeatStressManager sharedHeatStressManager];
...
{
    static NSString *CellIdentifier = @"HeatCell";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    catManager.category = 2;

    //NSLog(@"number of variables %d", numberOfVariables);
