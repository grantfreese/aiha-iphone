...
#import "ExposureListViewController.h"
...
#import "ExposureTableImageViewController.h"
#import "CategoryManager.h"

@implementation ExposureListViewController
...
//#warning Incomplete method implementation.
    ...
    return [Exposuremanager.formulas count];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    static NSString *CellIdentifier = @"ExposureCell";
    ...
    NSDictionary *formulaInfo = [Exposuremanager.formulas objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Exposuremanager.selectedFormula = [Exposuremanager.formulas objectAtIndex:indexPath.row];
    
    NSDictionary *chosenFormula = Exposuremanager.selectedFormula;
